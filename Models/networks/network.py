...
class Spatial_Atten_Unet(nn.Module):
    ...
    def __init__(self, args=None, in_ch=3, n_classes=2, feature_scale=4, is_deconv=True, is_batchnorm=True):
    ...
    def forward(self, inputs):
        ...
        # attention map 4
        # atten4_map = att4.cpu().detach().numpy().astype(np.float)
        # atten4_map = ndimage.interpolation.zoom(atten4_map, [1.0, 1.0, 224/atten4_map.shape[2],
        #                                                      300/atten4_map.shape[3]], order=0)
